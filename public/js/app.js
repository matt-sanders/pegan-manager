...
;
},{"vue":85,"vue-hot-reload-api":80}],79:[function(require,module,exports){
/**
 * vue-formly v0.1.2
...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["VueFormly"] = factory();
	else
		root["VueFormly"] = factory();
})(this, function() {
return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
/******/ 	var installedModules = {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-5126095a/FormlyForm.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        (0, _keys2.default)(this.form).forEach(function (key) {
	            if (typeof _this.form[key].value == 'undefined') _this.$set('form.' + key + '.value', '');
	        });
	        ...
	        this.$watch('form.$errors', function (val) {
	            ...
	            var valid = true;
	            (0, _keys2.default)(this.form.$errors).forEach(function (key) {
	                var errField = _this2.form.$errors[key];
	                (0, _keys2.default)(errField).forEach(function (errKey) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-0f44710a/FormlyField.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Vue = __webpack_require__(43);
	exports.default = {
	    props: ['form', 'key'],
	    computed: {
	        type: function type() {
	    ...
	    methods: {
	        validate: function validate() {
	            ...
	            if (field.required) {
	                ...
	                (0, _util.setError)(this.form, this.key, 'required', !field.value);
	            }

	            if (!field.validators) return;

	            (0, _keys2.default)(field.validators).forEach(function (validKey) {
	                if (!_this.form.$errors[_this.key][validKey]) _this.$set('form.$errors.' + _this.key + '.' + validKey, false);
	                if (!field.required && !field.value) return;

	                var validator = field.validators[validKey];

	                var valid = typeof validator == 'function' ? !validator(field) : !eval(validator);
	                (0, _util.setError)(_this.form, _this.key, validKey, valid);
	            });
	        }
	    },
	    components: (0, _util.getTypes)(),
	    created: function created() {
	        var _this2 = this;

	        this.validate();
	        this.$watch('form.' + this.key + '.value', function (val) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (Vue) {
	    Vue.filter('formlyFields', function (fields) {
	        var re = /^\$/;
	        var valid = (0, _keys2.default)(fields).filter(function (key) {
	            return !re.test(key);
	        });
	        return valid;
	    });
...
;
},{"vue":85,"vue-hot-reload-api":80}],80:[function(require,module,exports){
var Vue // late bind
...
},{"hammerjs":83}],85:[function(require,module,exports){
(function (process){
/*!
 * Vue.js v1.0.28
 * (c) 2016 Evan You
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-5430aac2", module.exports)
  } else {
    hotAPI.update("_v-5430aac2", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"./components/Loader.vue":92,"./components/Nav.vue":94,"./components/ToggleNav.vue":98,"./vuex/actions/auth":100,"./vuex/store":110,"vue":85,"vue-hot-reload-api":80}],88:[function(require,module,exports){
'use strict';
...
function deleteRecipe(recipeID) {
  setHeaders();
  return _vue2.default.http.delete(_constants.API_URL + 'recipe/' + recipeID);
}
...
},{"../constants":99,"vue":85}],89:[function(require,module,exports){
'use strict';
...
var _vueFormly = require('vue-formly');

var _vueFormly2 = _interopRequireDefault(_vueFormly);

var _vueFormlyBootstrap = require('vue-formly-bootstrap');

var _vueFormlyBootstrap2 = _interopRequireDefault(_vueFormlyBootstrap);
...
_vue2.default.use(_vueFormlyBootstrap2.default);
...
},{"./App.vue":87,"./api":88,"./components/Login.vue":93,"./components/RecipeEdit.vue":95,"./components/RecipeList.vue":97,"vue":85,"vue-formly":79,"vue-formly-bootstrap":78,"vue-resource":81,"vue-router":82,"vue-touch":84}],90:[function(require,module,exports){
'use strict';
...
},{"../vuex/actions/ingredients":101,"vue":85,"vue-hot-reload-api":80}],91:[function(require,module,exports){
'use strict';
...
},{"../vuex/actions/ingredients":101,"babel-runtime/core-js/object/keys":2,"vue":85,"vue-hot-reload-api":80}],92:[function(require,module,exports){
"use strict";
if (module.exports.__esModule) module.exports = module.exports.default
...
},{"vue":85,"vue-hot-reload-api":80}],93:[function(require,module,exports){
'use strict';
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!hotAPI.compatible) return
  if (!module.hot.data) {
    hotAPI.createRecord("_v-63f434e2", module.exports)
  } else {
    hotAPI.update("_v-63f434e2", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"../vuex/actions/auth":100,"vue":85,"vue-hot-reload-api":80}],94:[function(require,module,exports){
'use strict';
...
},{"../vuex/actions/menu":102,"vue":85,"vue-hot-reload-api":80}],95:[function(require,module,exports){
'use strict';
...
},{"../vuex/actions/recipes":103,"./RecipeIngredients.vue":96,"babel-runtime/core-js/object/keys":2,"vue":85,"vue-hot-reload-api":80}],96:[function(require,module,exports){
'use strict';
...
},{"../vuex/actions/ingredients":101,"./AddIngredient.vue":90,"./IngredientEdit.vue":91,"vue":85,"vue-hot-reload-api":80}],97:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    methods: {
        removeRecipe: function removeRecipe(recipe) {
            ...
            var c = confirm('Are you sure you want to delete this recipe?');
            if (c == true) {
...
},{"../vuex/actions/recipes":103,"vue":85,"vue-hot-reload-api":80}],98:[function(require,module,exports){
'use strict';
...
},{"../vuex/actions/menu":102,"vue":85,"vue-hot-reload-api":80}],99:[function(require,module,exports){
'use strict';
...
function checkAuth(_ref4) {
    ...
    console.log(parse_json(UrlBase64Decode(jwt.split('.')[1])));
...
},{"../../api":88,"../../app":89,"../mutation-types":109,"./utils.js":104}],101:[function(require,module,exports){
'use strict';
...
},{"../../api":88,"../mutation-types":109,"./utils.js":104}],102:[function(require,module,exports){
'use strict';
...
function setMenu(_ref, active) {
  var dispatch = _ref.dispatch;

  dispatch(_mutationTypes.SET_MENU, active);
}

},{"../mutation-types":109}],103:[function(require,module,exports){
'use strict';
...
function deleteRecipe(_ref4, recipe) {
    var _this2 = this;

    var dispatch = _ref4.dispatch;

    if (!recipe._id) return;
    Api.deleteRecipe(recipe._id).then(function (response) {
        _this2.setRecipes();
    }, function (response) {});
}

},{"../../api":88,"../../app":89,"../mutation-types":109,"./utils.js":104}],104:[function(require,module,exports){
'use strict';
...
},{"../mutation-types":109,"babel-runtime/helpers/defineProperty":5}],106:[function(require,module,exports){
'use strict';
...
},{"../mutation-types":109,"babel-runtime/helpers/defineProperty":5}],107:[function(require,module,exports){
'use strict';
...
},{"../mutation-types":109,"babel-runtime/helpers/defineProperty":5}],108:[function(require,module,exports){
'use strict';
...
var mutations = (_mutations = {}, (0, _defineProperty3.default)(_mutations, _mutationTypes.SET_RECIPES, function (state, recipes) {
    recipes.forEach(function (recipe) {
        if ((0, _typeof3.default)(recipe.ingredients) != 'object' || recipe.ingredients.length == 0) return true;
...
}), (0, _defineProperty3.default)(_mutations, _mutationTypes.UPDATE_RECIPE, function (state, recipe) {
    var updated = false;
    state.recipes.forEach(function (rec, idx) {
...
},{"../mutation-types":109,"babel-runtime/helpers/defineProperty":5,"babel-runtime/helpers/typeof":6}],109:[function(require,module,exports){
'use strict';
...
},{"./modules/auth":105,"./modules/ingredients":106,"./modules/menu":107,"./modules/recipes":108,"vue":85,"vuex":86}]},{},[89]);
